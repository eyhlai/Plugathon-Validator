...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationAdministration">
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/ext-MedicationAdministration2.AgreedDateTime']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/ext-MedicationAdministration2.AgreedDateTime': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/ext-MedicationAdministration2.InjectionPatchSite']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/ext-MedicationAdministration2.InjectionPatchSite': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationAdministration/f:extension/f:value[x] 1</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:MedicationAdministration/f:category/f:extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:MedicationAdministration/f:context/f:extension</sch:title>
