...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Dosage/f:timing/f:repeat">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/timing-exact']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/timing-exact': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Dosage/f:timing/f:repeat/f:extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Dosage/f:maxDosePerPeriod</sch:title>
