...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/ext-MedicationAgreement.NextPractitioner']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/ext-MedicationAgreement.NextPractitioner': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest/f:basedOn">
      ...
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/ext-MedicationAgreement.RelationMedicationUse']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/ext-MedicationAgreement.RelationMedicationUse': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationRequest/f:basedOn/f:extension</sch:title>
