...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationDispense">
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/ext-MedicationDispense.RequestDate']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/ext-MedicationDispense.RequestDate': maximum cardinality of 'extension' is 1</sch:assert>
